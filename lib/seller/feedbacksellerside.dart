...
class _SellerFeedbackState extends State<SellerFeedback> {
  ...
  void fetchFeedbackAndInitialize() async {
    WidgetsBinding.instance.addPostFrameCallback((_)  {
       storecontroller.getSellerShopFeedback("all");
    });
    // storecontroller.iseditreplylist();
  }

  String? selectedfeedbackfilteroption;

  final List<Map<String, dynamic>> feedbackfilteroptions = [
    {
      "id": "all",
      "status": "All",
    },
  ...
  void initState() {
    ...
    scrollcontroller.addListener(() {
      if (scrollcontroller.offset >=
        ...
        storecontroller.getSellerShopFeedback(storecontroller.sellersidefeedbackfiltervalue.value.toString());
      }
    });
  }
  ...
  @override
  void dispose() {
    storecontroller.sellersidefeedbackfiltervalue.value = '';
                  ...
                  : Form(
                      ...
                      child: Column(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Center(
                                    ...
                                    value: selectedfeedbackfilteroption,
                                    onChanged: (newValue) {
                                      selectedfeedbackfilteroption = newValue!;
                                      storecontroller
                                          .sellershopfeedbackspage.value = 1;
                                      storecontroller
                                          .getSellerShopFeedback(newValue);
                                    },
                            ...
                            storecontroller.getsellersideshoppfeedback.value
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Row(
                                                        children: [
                                                          CircleAvatar(
                                                            backgroundImage: NetworkImage(sellerfeedback
                                                                        ?.user
                                                                        ?.media
                                                                        ?.isEmpty ??
                                                                    false
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  SizedBox(
                                                                    width: 19.w,
                                                                    child: Text(
                                                                      "> ${toCamelCase(sellerfeedback?.product?.name ?? "")}",
                                                                      style: TextStyle(
                            ...
                            storecontroller
                                    .getsellersideshopfeedbackreloading.value
                                ? Center(
                                    child: customcircularprogress(),
                                  )
                                : const SizedBox(),
          ...
          Container(
            child: Card(
              ...
              child: Padding(
                ...
                child: Text(
                  counts,
                  style: TextStyle(color: const Color(0xffFFA149), fontSize: 12.sp),
                ),
              ),
            ),
          ),
