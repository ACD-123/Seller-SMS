...
CompletedOrdersModel? completedOrdersModelFromJson(String str) => str.isNotEmpty ? CompletedOrdersModel.fromJson(json.decode(str)) : null;

String? completedOrdersModelToJson(CompletedOrdersModel? data) => data != null ? json.encode(data.toJson()) : null;
