...
PendingOrdersModel? pendingOrdersModelFromJson(String str) => str.isNotEmpty ? PendingOrdersModel.fromJson(json.decode(str)) : null;

String? pendingOrdersModelToJson(PendingOrdersModel? data) => data != null ? json.encode(data.toJson()) : null;
